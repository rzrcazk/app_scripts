...
############## 圈x
#悦动族获取TOKEN
https:\/\/yuedongzu\.yichengw\.cn\/* url script-request-header https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@master/Task/yuedongzu.js

############## loon
#悦动族获取TOKEN
http-response https:\/\/yuedongzu\.yichengw\.cn\/* script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@master/Task/yuedongzu.js, requires-body=1,max-size=0, tag=悦动族获取TOKEN

############## surge
#悦动族获取TOKEN
悦动族获取TOKEN = type=http-response,pattern=https:\/\/yuedongzu\.yichengw\.cn\/*,script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@master/Task/yuedongzu.js
