...
#githubAC获取body
https:\/\/github\.com\/* url script-request-body https://cdn.jsdelivr.net/gh/rzrcazk/JavaScript@master/Task/githubAC.js

############## loon
#githubAC获取body
http-request https:\/\/github\.com\/* script-path=https://cdn.jsdelivr.net/gh/rzrcazk/JavaScript@master/Task/githubAC.js,requires-body=true, tag=githubAC获取body

############## surge

#githubAC获取body
githubACbody = type=http-request,pattern=https:\/\/github\.com\/*,requires-body=1,max-size=0,script-path=https://cdn.jsdelivr.net/gh/rzrcazk/JavaScript@master/Task/githubAC.js
