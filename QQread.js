...
############## 圈x
#QQ阅读APP获取url
https:\/\/(iostgw6\.reader\.qq\.com\/*||newios\.reader\.qq\.com\/*) url script-request-header https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts/QQread.js

############## loon
#QQ阅读APP获取url
http-request https:\/\/(iostgw6\.reader\.qq\.com\/*||newios\.reader\.qq\.com\/*) script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts/QQread.js, requires-header=true, tag=QQ阅读APP获取url

############## surge
#QQ阅读APP获取url
QQ阅读APP获取url = type=http-request,pattern=https:\/\/(iostgw6\.reader\.qq\.com\/*||newios\.reader\.qq\.com\/*),script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts/QQread.js
