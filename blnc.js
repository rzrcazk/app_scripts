...
[task_local]
#部落农场
1 0 * * * https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts/blnc.js, tag=部落农场, img-url=https://ae01.alicdn.com/kf/U7bcabce8ea7644f18e3c84f65907e34bf.jpg, enabled=true

[rewrite_local]
#部落农场
https://farming.blnc888.com/game.api url script-request-body https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts/blnc.js

#loon
https://farming.blnc888.com/game.api script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts/blnc.js, requires-body=true, timeout=10, tag=部落农场

#surge
部落农场 = type=http-request,pattern=https://farming.blnc888.com/game.api,requires-body=1,max-size=0,script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts/blnc.js,script-update-interval=0
