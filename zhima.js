...
#芝嫲视频获取body
https:\/\/api\.sxsjyzm\.com\/* url script-request-body https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@2.2/zhima.js

############## loon
#芝嫲视频获取body
http-request https:\/\/api\.sxsjyzm\.com\/* script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@2.2/zhima.js,requires-body=true, tag=芝嫲视频获取body

############## surge

#芝嫲视频获取body
芝嫲视频获取body = type=http-request,pattern=https:\/\/api\.sxsjyzm\.com\/*,requires-body=1,max-size=0,script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@2.2/zhima.js
