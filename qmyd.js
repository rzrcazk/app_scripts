...
############## 圈x
#全民悦动获取TOKEN
https:\/\/qmyd\.yichengw\.cn\/* url script-request-header https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@2.2/qmyd.js

############## loon
#全民悦动获取TOKEN
http-response https:\/\/qmyd\.yichengw\.cn\/* script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@2.2/qmyd.js, requires-body=1,max-size=0, tag=全民悦动获取TOKEN

############## surge
#全民悦动获取TOKEN
全民悦动获取TOKEN = type=http-response,pattern=https:\/\/qmyd\.yichengw\.cn\/*,script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@2.2/qmyd.js
