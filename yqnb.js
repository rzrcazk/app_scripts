...
>>点击  http://nb.ioxing.com/index.php/Home/Public/login1/newpid/9677  下载APP    谢谢支持
...
//////////////////////////// 圈x
//易趣牛帮获取header body  
http:\/\/nb\.ioxing\.com\/* url script-request-body https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@master/yqnb.js

//////////////////////////// loon
//易趣牛帮获取header body  
http-request http:\/\/nb\.ioxing\.com\/* script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@master/yqnb.js, requires-body=1,max-size=0, tag=易趣牛帮获取header body

//////////////////////////// surge
//易趣牛帮获取header body  
易趣牛帮获取header body = type=http-request,pattern=http:\/\/nb\.ioxing\.com\/*,requires-body=1,max-size=0,script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@master/yqnb.js
