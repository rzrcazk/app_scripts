...
[task_local]
#西梅
20 9 * * * https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts/ximei.js, tag=西梅, img-url=https://ae01.alicdn.com/kf/Ucd02ea79ef22473daf3576486d134509Q.jpg, enabled=true


[rewrite_local]
#西梅
https://app.hubonews.com/.+/articles/list url script-request-body https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts/ximei.js



#loon
https://app.hubonews.com/.+/articles/list script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts/ximei.js, requires-body=true, timeout=10, tag=西梅



#surge

西梅 = type=http-request,pattern=https://app.hubonews.com/.+/articles/list,requires-body=1,max-size=0,script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts/ximei.js,script-update-interval=0
