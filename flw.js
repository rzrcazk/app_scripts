...
############## 圈x
#返利网获取header
https:\/\/.+\.fanli\.com\/* url script-request-header https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@master/flw.js
#返利网获取body
https:\/\/.+\.fanli\.com\/* url script-request-body https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@master/flw.js

############## loon
#返利网获取header
http-request https:\/\/.+\.fanli\.com\/* script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@master/flw.js, requires-header=true, tag=返利网获取header

http-request https:\/\/.+\.fanli\.com\/* script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@master/flw.js,requires-body=1,max-size=0, tag=返利网获取body

############## surge
#返利网获取header
返利网获取header = type=http-request,pattern=https:\/\/.+\.fanli\.com\/*,script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@master/flw.js

#返利网获取body
返利网获取body = type=http-request,pattern=https:\/\/.+\.fanli\.com\/*,requires-body=1,max-size=0,script-path=https://cdn.jsdelivr.net/gh/rzrcazk/app_scripts@master/flw.js
